...
![Version](https://img.shields.io/badge/Version-2026--09--04-FF6B00?style=for-the-badge)
...
* **편리한 환경 설정 & 자동 업데이트 (Management & Updates):** 앱 설정에서 실시간으로 캐시 용량을 확인하고 비울 수 있습니다. 개인화된 앱 설정(테마, 블랙리스트 등)을 Base64로 인코딩 후 순수 `.json` 포맷으로 안전하게 내보내고 불러올 수 있습니다.
